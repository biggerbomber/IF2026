...
glm_third_1_simple <-glm_third_1
summary(glm_third_1_simple) 

confint_third_1 <- confint(glm_third_1_simple)
odds_ratios_third_1 <- exp(coef(glm_third_1_simple))
odds_ratios_third_1_confint <- exp(confint_third_1)
odds_ratios_third_1_confint
...
glm_half_1 <- glm(cbind(accident_data$X1.half.dead, accident_data$X1.half.total - accident_data$X1.half.dead) ~ 
                     accident_data$PhaseOfFlight + 
                     accident_data$Time + 
                     accident_data$Place + 
                     accident_data$HasFire + 
...
glm_half_2 <- glm(cbind(accident_data$X2.half.dead, accident_data$X2.half.total - accident_data$X2.half.dead) ~ 
                     accident_data$PhaseOfFlight + 
                     accident_data$Time + 
                     accident_data$Place + 
                     accident_data$HasFire + 
...
glm_total <- glm(cbind(accident_data$X1.third.dead + accident_data$X2.third.dead + accident_data$X3.third.dead, 
                 ...
                 family = quasibinomial(link = "logit"))
summary(glm_total)
glm_total_simple <- glm_total
summary(glm_total_simple)

# now get odds ratios and confidence intervals for the total model
confint_total <- confint(glm_total_simple)
odds_ratios_total <- exp(coef(glm_total_simple))
odds_ratios_total_confint <- exp(confint_total)
odds_ratios_total_confint
